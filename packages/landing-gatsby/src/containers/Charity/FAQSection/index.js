          ...
          <hr />
            ...
            <Heading as="h3" content="Healthcare Worker Heroes" id="healthcare" />
              <List>
                ...
                <Item ><b>My hospital requires that I wear a certain colour of scrubs. Can I request a certain colour?</b>- our view is that hospitals are hardly in a position to place demands on uniform colour with scrubs being so scarce. If that is to be mandated, they are welcome to provide scrubs in sufficient number for all healthcare workers to wear. A core value of Rona Scrubs is to try to meet the need for scrubs as far reaching as possible with no charge to our healthcare Heroes. As such, we are largely relying on donated fabrics, the colour of which we have no control over. We would love to be able to meet your scrub colour requests but unfortunately we are unable to do so.</Item>
