      ...
      <Container width="1260px">
        ...
        <ContentArea>
          ...
          <List >
            ...
            <Item><AnchorLink className="AnchorLink" to="/faq#healthcare"  title="Healthcare" >Healthcare heroes</AnchorLink></Item>
          ...
          <hr />
            <Heading as="h3" content="Volunteer Sewing Angels" id="volunteer" />
              <List>
                ...
                <Item ><b>University of Arts London scrubs pattern for the National Health Service (NHS)</b> - You might have seen that The University of Arts in London have made publicly available instructions on making scrubs. The instructions are awesome and it’s so generous that they are making these available publicly. If you would like to check them out and use them, feel free to – the pattern is pretty similar to what we are doing so it’s completely feasible to use. There are just two key things to note: <br />1.The instructions are probably a bit more difficult for those who are not experienced with drafting their own pattern. If you think you can do it, have a go (a great opportunity to learn a new skill)!<br /> 2. We weren’t able to find details on how to scale the size, if you do find it, please share it with us. In the interim, we did a comparison of the size based on the standard pattern making <a href="https://www.arts.ac.uk/students/stories/csm-loves-nhs#" target="_blank">guide here</a> and they are close enough to a Rona Scrubs size small.</Item>
                <Item ><b>Do I need an overlocker to make scrubs?</b> - No, there is no need for an overlocker. Seams must be neatened but feel free to use your favorite method, be it sewing with zigzag, using pinking shears or folding under and stitching. The important thing is that your scrubs are durable and can withstand repeated washing.</Item>
                <Item ><b>How much fabric is required?</b> - If you’re using the Simplicity #5443 pattern you will need approximately 1.8 metres for the top and 2.7 metres for the pants for medium and large sizes, so total 4.5 metres. For large sizes total fabric is 4.6 metres but usually they allow a bit extra so 4.5 metres. For X-Large, you will require 4.9 metres.</Item>
              </List>
            <Heading as="h3" content="Healthcare heroes" id="healthcare" />
              <List>
                ...
                <Item ><b>Can I request customised scrubs for my hard-to-fit body shape?</b> – given the volume of scrubs our volunteer sewers are trying to make for healthcare heroes, we cannot offer custom-sizing. If this is a real issue for you please email <a href="mailto:info@ronascrubs.com">info@ronascrubs.com</a> and we will do our best to accommodate your needs.</Item>
                ...
                <Item ><b>What are the laundering instructions?</b> - All healthcare heroes are instructed to wash the scrubs daily at 65 degrees Celsius if possible with your machine at home, or a cold wash followed by 15 minutes on the highest heat setting in the dryer. If a tumble dryer is not available, line dry scrubs in the sun. Alternatively, follow the instructions of your institution.</Item>
                ...
                <Item ><b>My hospital requires that I wear a certain colour of scrubs. Can I request a certain colour?</b> - our view is that hospitals will be flexable on uniform colour with scrubs being so scarce. If that is to be mandated, they are welcome to provide scrubs in sufficient number for all healthcare heroes to wear. A core value of Rona Scrubs is to try to meet the need for scrubs as far reaching as possible with no charge to our healthcare heroes. As such, we are largely relying on donated fabrics, the colour of which we have no control over. We would love to be able to meet your scrub colour requests but unfortunately we are unable to do so.</Item>
            ...
            <Heading as="h3" content="Donations" id="donations" />
              <List>
                ...
                <Item ><b>What will my donation be used for?</b> - donations will be used to help get supplies to our sewing Angels and then get the finished scrubs to healthcare heroes. They may also be used to purchase any additional items we might need to fill orders where we have not received a donation of goods or where we are running low. Examples include fabric, thread, and patterns. </Item>
            ...
            <List>
                <Item ><b>I am a volunteer/healthcare heroes and need to know my personal data will be protected/not used for unauthorised purposes</b> – we are currently preparing a privacy policy, but the key things to know in the meantime are:
