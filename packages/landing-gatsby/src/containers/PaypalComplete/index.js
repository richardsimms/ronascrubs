...
import { ErrorWrapper, ErrorConatent, ButtonWrapper } from './payplay.style';
  ...
  return (
    <ErrorWrapper>
      <ErrorConatent>
        ...
        <Text
          {...text}
          content="Your generosity will go a long way to supporting our mission to produce scrubs for our front line healthcare Heroes during the COVID-19 crisis."
        />
        <Text
          {...text}
          content="We are still working out how best we can keep you up to date with how things are progressing. In the interim, you can follow our Facebook group Rona Scrubs - Australia if you would like to.
